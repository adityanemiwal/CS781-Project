...
class Playground(MiniGridEnv):
    ...
    def __init__(self,
        ...
        self.probability_intended = 0.5
        self.probability_turn_intended = 0.5
    ...
    def _gen_grid(self, width, height):
        ...
        self.grid.horz_wall(2, 2, 1, slippery_south)
        self.grid.horz_wall(3, 3, 1, slippery_south)
        ...
        # self.grid.set(4, 5, Key(COLOR_NAMES[0]))
